...
module.exports = {
    ...
    run: async (client, message, args, prefix) => {
        ...
        let rules2 = new MessageEmbed()
            .setColor(ee.color)
            .setThumbnail("https://media.discordapp.net/attachments/1006566346068340850/1014538964251717712/standard.gif?width=827&height=465")
            .setTitle(`\`\`🔰 Chat Rules 🔰\`\``)
            .setFooter(ee.footertext)
            .setDescription(`
       ...
       `)
        ...
        let follow = new MessageEmbed()
            ...
            .setImage("https://media.discordapp.net/attachments/1006566346068340850/1014538964251717712/standard.gif?width=827&height=465")
            .setFooter(ee.footertext)
